...
void ssd1306_i2c_master_init(SSD1306_t * dev, int16_t sda, int16_t scl, int16_t reset);
void ssd1306_i2c_device_add(SSD1306_t * dev, i2c_port_t i2c_num, int16_t reset, uint16_t i2c_address);
void ssd1306_i2c_init(SSD1306_t * dev, int width, int height);
void ssd1306_i2c_display_image(SSD1306_t * dev, int page, int seg, uint8_t * images, int width);
void ssd1306_i2c_contrast(SSD1306_t * dev, int contrast);
void ssd1306_i2c_hardware_scroll(SSD1306_t * dev, ssd1306_scroll_type_t scroll);
